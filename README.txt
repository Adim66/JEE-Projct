...
a persistence unit "com.cinemaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "com.cinema/pom.xml":
...
artifact ("com.cinema.war") is already built. You can build
